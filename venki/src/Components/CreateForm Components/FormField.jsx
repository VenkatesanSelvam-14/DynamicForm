...
const FormField = ({ field, handleChange, handleRemove,handleChangeFieldValue }) => {
  ...
  return (
    ...
    <div className="form-field">
      ...
      <input
        type='text'
        placeholder="PositionNo"
        value={field.positionNo || ''}
        required={true}
        onChange={(e) => {
          handleChange(field.uniqueId, 'positionNo', e.target.value);
          
        }}
       
      />

      {field.type === 'text' || field.type === 'textarea' || field.type === 'number' || field.type === 'date' || field.type === 'email' ? (
        <input
          type={field.type}
      ...
      {field.type=== 'dropdown'?(
        <div>
          ...
          <input
            type="radio"
            value={true}
            onChange={(e) => {handleChange(field.uniqueId, 'MultipleChoise', e.target.value)
              }
            }/>
          </div>
      ):null}
